 ...
 *        files. Sample binary files are present in the following path :  
 *        
 *        $SRCHOME/dbjava/demo/samples/samplebinaries
 *
...
public class FileExample
{
       ...
       throws Exception
  {
    ...
    while (rset.next ())
    {
      ...
      OracleBfile bfile =(OracleBfile) ((OracleResultSet)rset).getBFILE (2);
