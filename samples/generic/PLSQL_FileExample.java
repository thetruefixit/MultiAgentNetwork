 ...
 *        Sample Binary files are provided in the following path
 *        $SRCHOME/dbjava/samples/samplebinaries/
 *
 *
 *
...
public class PLSQL_FileExample
{
       ...
       throws Exception
  {
    ...
    while (rset.next ())
    {
      ...
      OracleBfile bfile = ((OracleResultSet)rset).getBFILE (2);
  ...
  static void dumpBfile (Connection conn, OracleBfile bfile)
    throws Exception
  {
  ...
  static long getLength (Connection conn, OracleBfile bfile)
    throws SQLException
  {
  ...
  static boolean fileexists (Connection conn, OracleBfile bfile)
    throws SQLException
  {
    OracleCallableStatement cstmt =
      (OracleCallableStatement)
  ...
  static String filegetname (Connection conn, OracleBfile bfile)
    throws SQLException
  {
    OracleCallableStatement cstmt =
      (OracleCallableStatement)
  ...
  static OracleBfile fileopen (Connection conn, OracleBfile bfile)
    throws SQLException
  {
    OracleCallableStatement cstmt =
      (OracleCallableStatement)
  ...
  static boolean fileisopen (Connection conn, OracleBfile bfile)
    throws SQLException
  {
    OracleCallableStatement cstmt =
      (OracleCallableStatement)
  ...
  static void fileclose (Connection conn, OracleBfile bfile)
    throws SQLException
  {
    OracleCallableStatement cstmt =
      (OracleCallableStatement)
