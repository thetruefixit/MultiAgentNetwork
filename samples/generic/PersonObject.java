...
public class PersonObject
{
       ...
       throws Exception
  {
    ...
    OracleStruct address = ( OracleStruct ) conn.createStruct( "ADDRESS", address_attributes );

    Object [] person_attributes = new Object [2];
    person_attributes [0] = "Gary";
    person_attributes [1] = address;
    
    OracleStruct new_person = ( OracleStruct ) conn.createStruct( "PERSON", person_attributes );
    ...
    throws SQLException
  {
    while (rs.next ())
    {
      ...
      // retrieve the STRUCT 
      OracleStruct  person_struct = (OracleStruct)rs.getObject (2);
      Object person_attrs[] = person_struct.getAttributes();

      System.out.println ("person name:  " + 
                          (String) person_attrs[0]);

      OracleStruct address = (OracleStruct) person_attrs[1];
